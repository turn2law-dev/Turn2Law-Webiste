        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            >
              ...
              <Button asChild size="lg" className="rounded-full bg-[#D8A04A] hover:bg-[#D8A04A]/90 text-white font-semibold px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg w-full sm:w-auto">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" className="rounded-full bg-[#D8A04A] hover:bg-[#D8A04A]/90 text-white font-semibold px-8 py-6 text-base">
