              ...
              {stat.type === "stat" ? (
                <div className="space-y-2 w-full">
                  ...
                  <div className="absolute bottom-4 right-4 flex items-center gap-2">
                    <button className="bg-secondary hover:bg-secondary/80 dark:bg-[#D8A04A] dark:hover:bg-[#C78B35] text-secondary-foreground px-4 py-1.5 rounded-full text-xs font-medium transition-colors duration-200 flex items-center gap-1">
                      Consult
                      <svg
                        className="w-3 h-3"
                        fill="none"
