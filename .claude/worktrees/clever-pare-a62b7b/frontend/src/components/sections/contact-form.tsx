...
const contactCards = [
  ...
  { icon: Phone,    label: "PHONE",  value: "+91 9906102527",        href: "tel:+919906102527" },
  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl text-center">
        ...
        {/* Badge */}
        <motion.div
          initial={prefersReducedMotion ? false : { opacity: 0, scale: 0.88, y: 12 }}
        ...
        {/* Heading */}
        <motion.h2
          initial={prefersReducedMotion ? false : { opacity: 0, y: 36, filter: "blur(8px)" }}
